...
<div class="wrap">
  <div class="card">
    <div class="brand">
      ...
      <div><div class="brand-name">tokenPanel</div><div class="brand-sub">v9.5</div></div>
    </div>
    <h1>ورود به پنل</h1>
    ...
    <div class="hint">
      ...
      <span class="hint-val" onclick="document.getElementById('pw').value='tokenPanel';document.getElementById('pw').focus()">tokenPanel</span>
    </div>
    <form id="form">
      <div class="field">
...
<aside class="sidebar" id="sb">
  ...
  <div class="logo">
    ...
    <div><div class="logo-name">tokenPanel</div><div class="logo-sub">v9.5</div></div>
  </div>
  <div class="nav-wrap">
...
<section class="pg on" id="pg-overview">
  ...
  <div class="dash-footer">
    <span class="df-text">tokenPanel 1.0</span>
...
<section class="pg" id="pg-support">
  ...
  <div class="srv-panel">
    <div class="srv-hero">
      ...
      <div class="srv-hero-text">
        <div class="srv-hero-domain">پشتیبانیtokenPanel</div>
        <div class="srv-hero-sub"><span class="dot dg pulse"></span> راه‌های ارتباطی با تیم tokenPanel</div>
      </div>
    </div>
    <div class="srv-tiles">
      <a class="srv-tile" href="naull" target="_blank" style="text-decoration:none;cursor:pointer">
        <div class="srv-tile-icon"><i class="ti ti-brand-youtube"></i></div>
        <div class="srv-tile-text"><div class="srv-tile-label">یوتیوب</div><div class="srv-tile-val">naull</div></div>
      </a>
      <a class="srv-tile" href="https://t.me/Farajian2004m" target="_blank" style="text-decoration:none;cursor:pointer">
        ...
        <div class="srv-tile-text"><div class="srv-tile-label">آیدی تلگرام</div><div class="srv-tile-val">@tokenshack</div></div>
      </a>
      <a class="srv-tile" href="https://t.me/x4g_group" target="_blank" style="text-decoration:none;cursor:pointer">
        ...
        <div class="srv-tile-text"><div class="srv-tile-label">گروه تلگرام</div><div class="srv-tile-val">null</div></div>
      </a>
      <a class="srv-tile" href="https://t.me/vpnfreev2rayconfig" target="_blank" style="text-decoration:none;cursor:pointer">
        ...
        <div class="srv-tile-text"><div class="srv-tile-label">کانال تلگرام</div><div class="srv-tile-val">https://t.me/tokenshack_info</div></div>
      </a>
      <a class="srv-tile" href="https://github.com/tokenPanel" target="_blank" style="text-decoration:none;cursor:pointer">
        <div class="srv-tile-icon"><i class="ti ti-brand-github"></i></div>
        <div class="srv-tile-text"><div class="srv-tile-label">گیت‌هاب</div><div class="srv-tile-val">github.com/tokenPanel</div></div>
      </a>
    </div>
  </div>
</section>
...
<script>
let isDark=localStorage.getItem('tokenPanel-theme')!=='light';
...
function toggleTheme(){isDark=!isDark;localStorage.setItem('tokenPanel-theme',isDark?'dark':'light');applyTheme(isDark)}
applyTheme(isDark);
...
<div class="wrap">
  ...
  <div class="footer">پشتیبانی: <a href="https://t.me/Farajian2004f" target="_blank">@Farajian2004f</a> · tokenPanel v1.0</div>
</div>
<script>
const UUID_KEY='{uuid_key}';
let savedPw='';

let isDark=localStorage.getItem('tokenPanel-pub-theme')!=='light';
function applyTheme(dark){{
  document.documentElement.setAttribute('data-theme',dark?'dark':'light');
  document.getElementById('theme-icon').className='ti '+(dark?'ti-sun':'ti-moon');
}}
function toggleTheme(){{isDark=!isDark;localStorage.setItem('tokenPanel-pub-theme',isDark?'dark':'light');applyTheme(isDark)}}
applyTheme(isDark);
...
function renderContent(d){{
  ...
  window._tokenPanelSubUrl  = subUrl;
  window._tokenPanelSubName = d.name;
  window._tokenPanelLinks   = d.links.map(l => ({{
    vless : l.vless_link,
    ...
    <div class="sub-info">
      ...
      <div class="sub-sub-box">
        ...
        <button class="btn btn-pur" style="padding:7px 12px;font-size:10.5px"
          onclick="navigator.clipboard.writeText(window._tokenPanelSubUrl).then(()=>toast('لینک ساب کپی شد ✓','ok'))">
          <i class="ti ti-copy"></i> کپی لینک ساب
        </button>
        <button class="btn btn-g" style="padding:7px 12px;font-size:10.5px"
          onclick="showQR(window._tokenPanelSubName + ' — کل گروه', window._tokenPanelSubUrl)">
            ...
            <div class="cfg-bottom">
              ...
              <div class="cfg-actions">
                <button class="btn btn-p"
                  onclick="navigator.clipboard.writeText(window._tokenPanelLinks[${{i}}].vless).then(()=>toast('لینک کپی شد ✓','ok'))">
                  <i class="ti ti-copy"></i> کپی لینک
                </button>
                <button class="btn btn-g"
                  onclick="showQR(window._tokenPanelLinks[${{i}}].label, window._tokenPanelLinks[${{i}}].vless)">
...
function copyAllConfigs(){{
  const links=window._tokenPanelLinks||[];
